...
namespace ARSandbox.TopographyBuilder
{
    public class UI_TopographyRename : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            InputTitle = localizationManager.LocateStringtoDatabase("Topography_RenameTopography");
            InputText = localizationManager.LocateStringtoDatabase("Topography_NoTopographySelected");
