...
namespace ARSandbox.TopographyBuilder
{
    public class UI_SaveTopographyBtn : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            InputTitle = localizationManager.LocateStringtoDatabase("Topography_TopographyName");
            InitialText = localizationManager.LocateStringtoDatabase("OnScreenKeyboard_EnterName");
        }
