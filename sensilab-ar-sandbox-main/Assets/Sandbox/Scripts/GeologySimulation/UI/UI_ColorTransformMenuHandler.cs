...
namespace ARSandbox.GeologySimulation
{
    public class UI_ColorTransformMenuHandler : MonoBehaviour
    {
        ...
        //Vou colocar a String da traducão
        public const string BED_MENU_TITLE = "Geology_Beds";
        public const string ADD_BED_MENU_TITLE = "Geology_Beds_AddBed_AddBedMenu";
        public const string EDIT_BED_MENU_TITLE = "Geology_Beds_AddBed_EditBedMenu";
        public const string TRANSFORM_MENU_TITLE = "Transforms";
        public const string ADD_TRANSFORM_MENU_TITLE = "Geology_Beds_AddBed_AddBedMenu";
        public const string EDIT_TRANSFORM_MENU_TITLE = "Geology_Beds_AddBed_EditBedMenu";
        ...
        public void OpenEditBedMenu(GeologicalLayer layer)
        {
            ...
            SetTitleColourAndText(BedColour, localizationManager.LocateStringtoDatabase(EDIT_BED_MENU_TITLE));
        ...
        public void OpenAddBedMenu(GeologicalLayer layer)
        {
            ...
            ToggleMenuButtons(false);
            SetTitleColourAndText(BedColour, localizationManager.LocateStringtoDatabase(ADD_BED_MENU_TITLE));
        ...
        public void OpenEditTransformMenu(GeologicalTransform transform)
        {
            ...
            ToggleMenuButtons(false);
            SetTitleColourAndText(TransformColour, localizationManager.LocateStringtoDatabase(EDIT_TRANSFORM_MENU_TITLE));
            UI_MenuBG.color = TransformColour;
        }
        ...
        public void OpenAddTransformMenu(GeologicalTransform transform)
        {
            ...
            ToggleMenuButtons(false);
            SetTitleColourAndText(TransformColour, localizationManager.LocateStringtoDatabase(ADD_TRANSFORM_MENU_TITLE));
            UI_MenuBG.color = TransformColour;
        }
    }
}
