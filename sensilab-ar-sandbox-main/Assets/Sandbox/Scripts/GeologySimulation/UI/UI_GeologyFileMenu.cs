...
namespace ARSandbox.GeologySimulation
{
    public class UI_GeologyFileMenu : MonoBehaviour
    {
        ...
        {
            LocalizationFind();
            saveInputTitle = localizationManager.LocateStringtoDatabase("OnScreenKeyboard_GeologyFileName");
            saveInitialText = localizationManager.LocateStringtoDatabase("OnScreenKeyboard_EnterName");
            noFileSelectedText = localizationManager.LocateStringtoDatabase("Geology_SaveLoad_NoFileSelected");
            renameInputTitle = localizationManager.LocateStringtoDatabase("OnScreenKeyboard_RenameGeologyFile");
        }
