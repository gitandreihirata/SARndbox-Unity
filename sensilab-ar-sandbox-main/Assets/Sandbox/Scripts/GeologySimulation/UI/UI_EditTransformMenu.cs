        ...
        private void OpenExtraOptions()
        {
            switch (geologicalTransform.Type)
            {
                case GeologicalTransform.TransformType.TiltTransform:
                    ...
                    UI_PlungeRakeTitle.text = localizationManager.LocateStringtoDatabase("Geology_Transforms_EditTransformMenu_TransformOptions_Plunge");
                    break;

                case GeologicalTransform.TransformType.FoldTransform:
                    UI_AmplitudeTitle.SetActive(true);
                    UI_AmplitudeTitle.GetComponentInChildren<Text>().text = localizationManager.LocateStringtoDatabase("Geology_Transforms_EditTransformMenu_ExtraOptions_Amplitude");
                    ...
                    UI_OffsetTitle.GetComponentInChildren<Text>().text = localizationManager.LocateStringtoDatabase("Geology_Transforms_EditTransformMenu_ExtraOptions_Offset");
                    ...
                    UI_ColourSelectionTitle1.GetComponentInChildren<Text>().text = localizationManager.LocateStringtoDatabase("Geology_Transforms_EditTransformMenu_ExtraOptions_Syncline_Hinge_Colour");
                    UI_Colour1ScrollRect.gameObject.SetActive(true);
                    UI_ColourSelectionTitle2.SetActive(true);
                    UI_ColourSelectionTitle2.GetComponentInChildren<Text>().text = localizationManager.LocateStringtoDatabase("Geology_Transforms_EditTransformMenu_ExtraOptions_Anticline_Hinge_Colour");
                ...
                case GeologicalTransform.TransformType.FaultTransform:
                    UI_AmplitudeTitle.SetActive(true);
                    UI_AmplitudeTitle.GetComponentInChildren<Text>().text = localizationManager.LocateStringtoDatabase("Geology_Transforms_EditTransformMenu_ExtraOptions_Slip");
                    UI_AmplitudeTitle.GetComponent<RectTransform>().sizeDelta = new Vector2(108.5f, 25);
                    UI_AmplitudeSlider.SetActive(true);
                    UI_PeriodTitle.SetActive(false);
                    UI_PeriodSlider.SetActive(false);
                    UI_OffsetTitle.SetActive(true);
                    UI_OffsetTitle.GetComponentInChildren<Text>().text = localizationManager.LocateStringtoDatabase("Geology_Transforms_EditTransformMenu_ExtraOptions_Position");
                    ...
                    UI_ColourSelectionTitle1.GetComponentInChildren<Text>().text = localizationManager.LocateStringtoDatabase("Geology_Transforms_EditTransformMenu_ExtraOptions_FaultColour");
                    UI_Colour1ScrollRect.gameObject.SetActive(true);
                    UI_ColourSelectionTitle2.SetActive(false);
                    UI_Colour2ScrollRect.gameObject.SetActive(false);
                    ...
                    UI_PlungeRakeTitle.text = localizationManager.LocateStringtoDatabase("Geology_Transforms_EditTransformMenu_TransformOptions_Rake");
                    break;
            }
        }
