...
namespace ARSandbox.GeologySimulation
{
    ...
    namespace GeologicalTransforms {
        ...
        {
            protected static S_LocalizationManager localizationManager;

            static GeologicalTransform()
            {
            ...
            protected static string Translate(string key)
            {
                ...
                {
                    return localizationManager.LocateStringtoDatabase(key);
                }
                return key;
            }
            ...
            {
                var localizationManager = S_LocalizationManagerAccessor.GetLocalizationManager();

                switch (type)
                {
                    case TransformType.TiltTransform:
                        //return TiltTransform.TRANSFORM_TITLE;
                        return localizationManager.LocateStringtoDatabase("Geology_Transforms_EditTransformMenu_SelectTransform_Tilt");
                    case TransformType.FoldTransform:
                        //return FoldTransform.TRANSFORM_TITLE;
                        return localizationManager.LocateStringtoDatabase("Geology_Transforms_EditTransformMenu_SelectTransform_Fold");
                    case TransformType.FaultTransform:
                        //return FaultTransform.TRANSFORM_TITLE;
                        return localizationManager.LocateStringtoDatabase("Geology_Transforms_EditTransformMenu_SelectTransform_Fault");
                }
                return localizationManager.LocateStringtoDatabase("Geology_Transforms_EditTransformMenu_SelectTransform_UnknownTransform");
            }
        }
