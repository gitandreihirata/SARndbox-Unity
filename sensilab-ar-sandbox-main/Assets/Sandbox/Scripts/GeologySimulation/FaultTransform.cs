...
namespace ARSandbox.GeologySimulation.GeologicalTransforms
{
    public class FaultTransform : GeologicalTransform
    {
        ...
        public new static string TRANSFORM_TITLE;
        static FaultTransform()
        {
            TRANSFORM_TITLE = Translate("Geology_Transforms_EditTransformMenu_SelectTransform_FaultTransform");
        }
