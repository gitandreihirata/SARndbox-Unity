...
namespace ARSandbox.FireSimulation
{
    public class UI_FireSimulationMenu : MonoBehaviour
    {
        ...
        public void OpenMenu()
        {
            ...
            {
                UI_PlayPauseBtnText.text = localizationManager.LocateStringtoDatabase("Fire_ResumeSimulation");
            }
            else
            {
                UI_PlayPauseBtnText.text = localizationManager.LocateStringtoDatabase("Fire_PauseSimulation");
            }
        }
