...
namespace ARSandbox
{
    public class UI_SliderValueText : MonoBehaviour
    {
        ...
        {
            Debug.Log("UI_SliderValueText.UpdateText");
            string StrValue = "Value:";
            //string StrValue = localizationManager.LocateStringtoDatabase("Standard_Value");
            SliderTextBox.text = StrValue +" " + (Mathf.Round(value * 100) / 100).ToString();
        }
    }
}
