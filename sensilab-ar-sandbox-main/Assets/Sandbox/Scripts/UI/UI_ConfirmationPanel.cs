...
namespace ARSandbox
{
    public class UI_ConfirmationPanel : MonoBehaviour
    {
        ...
        [HideInInspector]
        public string TOPOGRAPHY_DELETE_TEXT;
        [HideInInspector]
        public string GEOLOGY_DELETE_TEXT;
        [HideInInspector]
        public string GEOLOGY_OPEN_TEXT ;
        [HideInInspector]
        public string GEOLOGY_REPLACE_FILE ;
        [HideInInspector] 
        public string EMAIL_SEND_TEXT ;
        [HideInInspector]
        public string DESKTOP_SAVE_TEXT ;
        ...
        private void Awake()
        {
            ...
            CANCEL_TEXT = S_Utilities.ProcessNewLines(localizationManager.LocateStringtoDatabase("ConfirmationPanel_Calibration_CancelCurrentCalibration"));
            TOPOGRAPHY_DELETE_TEXT = S_Utilities.ProcessNewLines(localizationManager.LocateStringtoDatabase("ConfirmationPanel_Topography_Delete"));
            GEOLOGY_DELETE_TEXT = S_Utilities.ProcessNewLines(localizationManager.LocateStringtoDatabase("ConfirmationPanel_Geology_Delete"));
            GEOLOGY_OPEN_TEXT = S_Utilities.ProcessNewLines(localizationManager.LocateStringtoDatabase("ConfirmationPanel_Geology_Open"));
            GEOLOGY_REPLACE_FILE = S_Utilities.ProcessNewLines(localizationManager.LocateStringtoDatabase("ConfirmationPanel_Geology_Saved"));
            EMAIL_SEND_TEXT = S_Utilities.ProcessNewLines(localizationManager.LocateStringtoDatabase("ConfirmationPanel_Email_SendingCapture"));
            DESKTOP_SAVE_TEXT = S_Utilities.ProcessNewLines(localizationManager.LocateStringtoDatabase("ConfirmationPanel_SavingCapture"));
        ...
        public void SetUpCalibrationCancelPanel()
        {
            ...
            CancelButtonText.text = localizationManager.LocateStringtoDatabase("Calibration_BackCalibration");
            AcceptButtonText.text = localizationManager.LocateStringtoDatabase("Calibration_CancelCalibration");
        ...
        public void SetUpTopographyDeletePanel()
        {
            ...
            CancelButtonText.text = localizationManager.LocateStringtoDatabase("ConfirmationPanel_Cancel");
            AcceptButtonText.text = localizationManager.LocateStringtoDatabase("ConfirmationPanel_Delete");
        ...
        public void SetUpGeologyFileSelectPanel(string filename)
        {
            ...
            CancelButtonText.text = localizationManager.LocateStringtoDatabase("ConfirmationPanel_Cancel");
            AcceptButtonText.text = localizationManager.LocateStringtoDatabase("ConfirmationPanel_Open");
        ...
        public void SetUpGeologyFileReplacePanel(string filename)
        {
            ...
            CancelButtonText.text = localizationManager.LocateStringtoDatabase("ConfirmationPanel_Cancel");
            AcceptButtonText.text = localizationManager.LocateStringtoDatabase("ConfirmationPanel_Save");
        ...
        private void SaveToDesktop()
        {
            ...
            AcceptButton.onClick.AddListener(ClosePanel);
            AcceptButton.gameObject.SetActive(true);
            AcceptButtonText.text = localizationManager.LocateStringtoDatabase("ConfirmationPanel_Close");

            if (saveOutcome)
            {
                UI_InfoTextBG.color = new Color(0, 1, 0);
                ConfirmationText.text = S_Utilities.ProcessNewLines(localizationManager.LocateStringtoDatabase("ConfirmationPanel_CaptureSaved")); 
            } else
            {
                UI_InfoTextBG.color = new Color(1, 100.0f / 255.0f, 100.0f / 255.0f);
                ConfirmationText.text = S_Utilities.ProcessNewLines(localizationManager.LocateStringtoDatabase("ConfirmationPanel_couldntBeSaved"));
            }
        }
        ...
        public void SetUpConfirmEmailPanel(string emailAddress, string captureName)
        {
            ...
            CancelButtonText.text = localizationManager.LocateStringtoDatabase("ConfirmationPanel_Cancel");
            AcceptButtonText.text = localizationManager.LocateStringtoDatabase("ConfirmationPanel_Send");
        ...
        private void SetUpEmailSendingPanel()
        {
            ...
            AcceptButton.gameObject.SetActive(true);
            AcceptButtonText.text = localizationManager.LocateStringtoDatabase("ConfirmationPanel_Email_CancelSendingEmail");

            UI_InfoTextBG.color = new Color(1, 1, 1);
            ConfirmationText.text = "\n" + localizationManager.LocateStringtoDatabase("ConfirmationPanel_Email_SendingEmail") + "   \n";
        ...
        private void CancelEmail()
        {
            ...
            ConfirmationText.text = S_Utilities.ProcessNewLines(localizationManager.LocateStringtoDatabase("ConfirmationPanel_Email_SendingEmailCancelled"));
        ...
        private void SendCompletedCallback(object sender, AsyncCompletedEventArgs e)
        {
            ...
            if (!emailCancelled)
            {
                ...
                {
                    UI_InfoTextBG.color = new Color(1, 100.0f / 255.0f, 100.0f / 255.0f);
                    ConfirmationText.text = S_Utilities.ProcessNewLines(localizationManager.LocateStringtoDatabase("ConfirmationPanel_Email_CouldNotbeSent"));
                }
                else
                {
                    UI_InfoTextBG.color = new Color(0, 1, 0);
                    ConfirmationText.text = S_Utilities.ProcessNewLines(localizationManager.LocateStringtoDatabase("ConfirmationPanel_Email_Sent"));
