...
namespace ARSandbox
{
    public class UI_SharingMenu : MonoBehaviour
    {
        ...
        public void UI_SelectEmailShare()
        {
            ...
            UI_ImageSharingModeTitle.text = localizationManager.LocateStringtoDatabase("ShareData_ShareTo_Email");
            ...
            UI_SendButtonText.text = localizationManager.LocateStringtoDatabase("ShareData_ShareTo_Email_SendEmail");
        }
        public void UI_SelectDesktopShare()
        {
            ...
            UI_ImageSharingModeTitle.text = localizationManager.LocateStringtoDatabase("ShareData_ShareTo_Desktop_DesktopFolder");         
            UI_ImageSharingModeTitleBG.sizeDelta = 
            ...
            UI_EmailInputText.text = localizationManager.LocateStringtoDatabase("ShareData_ShareTo_Email_LookInARSandboxData");
            UI_SendButtonText.text = localizationManager.LocateStringtoDatabase("ConfirmationPanel_Save");       
        }
