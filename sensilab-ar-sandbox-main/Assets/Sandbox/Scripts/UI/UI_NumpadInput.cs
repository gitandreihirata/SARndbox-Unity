...
namespace ARSandbox
{
    public class UI_NumpadInput : MonoBehaviour
    {
        ...
        public void OnClick()
        {
            String InputTitle2 = localizationManager.LocateStringtoDatabase(InputTitle);
            UI_MenuManager.OpenOnScreenNumpad(InputTitle2, InputNumber, Action_AcceptInput, Action_CancelInput);
        }
